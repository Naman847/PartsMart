    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            profileForm.addEventListener('submit', function (e) {
                ...
                // If no changes, show error message and prevent submission
                if (!hasChanges) {
                ...
                // Validation rules from signup.php
                ...
                if (!nameRegex.test(firstName)) {
                    ...
                    document.getElementById('first_name_error').textContent =
                        'First Name must contain only alphabets and at least 2 characters.';
                }
                ...
                if (!nameRegex.test(lastName)) {
                    ...
                    document.getElementById('last_name_error').textContent =
                        'Last Name must contain only alphabets and at least 2 characters.';
                }

                // Email validation (though readonly, we'll validate for consistency)
                ...
                // If valid and changes detected, show success message and submit
                if (isValid && hasChanges) {
                    successMessage.style.display = 'block';
                    errorMessage.style.display = 'none';
                    e.preventDefault(); // Prevent default submission to show success message
                    setTimeout(function () {
                        profileForm.submit(); // Submit after delay
