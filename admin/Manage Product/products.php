...
$categoryQuery = "SELECT Category_Id, Category_Name FROM category_tbl WHERE Visibility_Mode = 1";
...
// Fetch the latest Product_Id using prepared statement
...
<body>
        ...
        <table id="product-table">
            ...
            <?php foreach ($products as $index => $product): ?>
                <tr>
                    ...
                    <td><input type="number" name="moq[]" class="editable-input" value="<?= $product['MOQ'] ?>" disabled
                            min="1"></td>
                    <td>
                        <!-- In products.php, change this line in the variants column -->
    ...
    <script>
        ...
        `;
            enableEditing(); // Enable editing for new row immediately
        }
    </script>
