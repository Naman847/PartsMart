...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .modify-btn { font-size: 18px; padding: 14px; }
            .image-container { flex-direction: column; align-items: center; }
            .image-container div { width: 80%; margin-bottom: 15px; }
        }
    </style>
</head>
<body>
    <div class="form-container">
        ...
        <form method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
            <div class="image-container">
                <div>
                    <img id="product-image-preview" src="<?= htmlspecialchars($existingImage) ?>" alt="Product Image">
                    <p>Product Image</p>
